...
import com.android.settings.users.colorpicker.ColorPickerDialog;
...
public class Toolbar extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHaloButtonColor = (Preference) prefSet.findPreference(KEY_HALO_BUTTON_COLOR);
        mHaloTextBubbleColor = (Preference) prefSet.findPreference(KEY_HALO_TEXT_BUBBLE_COLOR);
        mHaloPingColor = (Preference) prefSet.findPreference(KEY_HALO_PING_COLOR);
